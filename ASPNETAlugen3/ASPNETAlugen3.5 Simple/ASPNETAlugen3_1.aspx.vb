...
Public Class ASPNETAlugen3_1
    ...
    Public ActiveLock3AlugenGlobals_definst As New ActiveLock3_5NET.AlugenGlobals
    Public ActiveLock3Globals_definst As New ActiveLock3_5NET.Globals_Renamed
    Public GeneratorInstance As ActiveLock3_5NET._IALUGenerator
    Public ActiveLock As ActiveLock3_5NET._IActiveLock
