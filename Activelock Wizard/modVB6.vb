Module modVB6
    ...
    Private Sub CreateRoutineInitActivelock()
        ...
        WriteToFile("   Call CheckForResources(" & Chr(34) & "activelock3.6.dll" & Chr(34) & ", " & Chr(34) & "mscomctl.ocx" & Chr(34) & ")" & vbCrLf)
        ...
        WriteToFile("   If Trim(AppfilePath) <> Chr(0) Then" & vbCrLf)
        WriteToFile("   AppfilePath = Left(AppfilePath, InStr(AppfilePath, Chr(0)) - 1)" & vbCrLf)
        ...
        WriteToFile("       If FolderExists(" & Chr(34) & "c:\temp" & Chr(34) & ") = False Then" & vbCrLf)
        WriteToFile("          MkDir(" & Chr(34) & "c:\temp" & Chr(34) & ")" & vbCrLf)
        WriteToFile("       End If" & vbCrLf)
        WriteToFile("       strAutoRegisterKeyPath = " & Chr(34) & "c:\temp\" & Chr(34) & " & .SoftwareName & .SoftwareVersion & " & Chr(34) & ".all" & Chr(34) & vbCrLf)
        ...
        WriteToFile("   ActivelockValues.Checksum = VerifyActiveLockdll" & vbCrLf)
        ...
        WriteToFile("   If FolderExists(AppfilePath & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion) = False Then" & vbCrLf)
        WriteToFile("       MkDir(AppfilePath & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion)" & vbCrLf)
        WriteToFile("   End If" & vbCrLf)
        WriteToFile("   strKeyStorePath = AppfilePath & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion & " & Chr(34) & ".lic" & Chr(34) & vbCrLf)
        ...
        WriteToFile("   Dim strRemainingTrialDays As String" & vbCrLf)
        WriteToFile("   Dim strRemainingTrialRuns As String" & vbCrLf)
        WriteToFile("   Dim strTrialLength As String" & vbCrLf)
        WriteToFile("   Dim strUsedDays As String" & vbCrLf)
        WriteToFile("   Dim strExpirationDate As String" & vbCrLf)
        WriteToFile("   Dim strRegisteredUser As String" & vbCrLf)
        WriteToFile("   Dim strRegisteredLevel As String" & vbCrLf)
        WriteToFile("   Dim strLicenseClass As String" & vbCrLf)
        WriteToFile("   Dim strMaxCount As String" & vbCrLf)
        WriteToFile("   Dim strLicenseFileType As String" & vbCrLf)
        WriteToFile("   Dim strLicenseType As String" & vbCrLf)
        WriteToFile("   Dim strUsedLockType As String" & vbCrLf)
        WriteToFile("   MyActiveLock.Acquire strMsg, strRemainingTrialDays, strRemainingTrialRuns, strTrialLength, strUsedDays, strExpirationDate, strRegisteredUser, strRegisteredLevel, strLicenseClass, strMaxCount, strLicenseFileType, strLicenseType" & vbCrLf)
        ...
        WriteToFile("   ActivelockValues.RegisteredUser = strRegisteredUser" & vbCrLf) '
        WriteToFile("   ActivelockValues.RegisteredLevel = strRegisteredLevel" & vbCrLf) '
        WriteToFile("   ' Networked Licenses" & vbCrLf)
        WriteToFile("   If strLicenseClass =  " & Chr(34) & "0" & Chr(34) & " Then 'MultiUser" & vbCrLf)
