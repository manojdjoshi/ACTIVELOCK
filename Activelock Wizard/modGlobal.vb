...
#End Region '"LocalVariables"
    ...
    Sub main(ByVal Args() As String)
        ...
        For Each value As String In Args
            ...
            End If
            If value.Contains("AppPassword=") Then
                i = value.Length
                j = value.IndexOf("=") + 1
                SoftwarePassword = Strings.Right(value, i - j)
            End If
            ...
            End If
            If value.Contains("DevEnv=") Then
                i = value.Length
                j = value.IndexOf("=") + 1
                DevEnv = Strings.Right(value, i - j)
                If StrComp(DevEnv, "VB2003", CompareMethod.Binary) = 0 Then
                    DevEnvironment = DevEnvironment_t.vb2003
                ElseIf StrComp(DevEnv, "VB2005", CompareMethod.Binary) = 0 Then
                    DevEnvironment = DevEnvironment_t.vb2005
                ElseIf StrComp(DevEnv, "VB2008", CompareMethod.Binary) = 0 Then
                    DevEnvironment = DevEnvironment_t.vb2008
                Else
                    DevEnvironment = DevEnvironment_t.vb6
                End If
            End If
        Next
        frmMain.ShowDialog()
    ...
    Public Function GetHideTypeStringVB6(ByVal HideType As ArrayList) As String
        Dim strHideType As String = Nothing
        For Each item As String In HideType
            strHideType = strHideType & item.ToString & " Or "
        Next
        strHideType = Strings.Left(strHideType, (strHideType.Length - 4))
        Return strHideType
    End Function
    ...
    Public Function GetLockTypesStringVB6(ByVal LockType As ArrayList) As String
        Dim stringLockType As String = Nothing
        For Each item As String In LockType
            stringLockType = stringLockType & item.ToString & " Or "
        Next
        stringLockType = Strings.Left(stringLockType, (stringLockType.Length - 4))
        Return stringLockType
    End Function
