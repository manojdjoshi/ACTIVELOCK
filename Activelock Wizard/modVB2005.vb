Module modVB2005
    ...
    Private Sub CreateRoutineInitActivelock()
        ...
        WriteToFile("        Call CheckForResources(" & Chr(34) & "#ActiveLock3_6Net.dll" & Chr(34) & ")" & vbCrLf)
        WriteToFile("        Dim Ret As Long" & vbCrLf)
        WriteToFile("        Dim AppfilePath As String" & vbCrLf)
        WriteToFile("        AppfilePath = Space$(260)" & vbCrLf)
        WriteToFile("        Ret = SHGetSpecialFolderPath(0, AppfilePath, 46, False) ' 46 is for ...\All Users\Documents folder." & vbCrLf)
        WriteToFile("        If AppfilePath.Trim <> Chr(0) Then" & vbCrLf)
        WriteToFile("        AppfilePath = Strings.Left(AppfilePath, InStr(AppfilePath, Chr(0)) - 1)" & vbCrLf)
        ...
        WriteToFile("             If Directory.Exists(AppfilePath & " & Chr(34) & " \ " & Chr(34) & " & .SoftwareName & .SoftwareVersion) = False Then" & vbCrLf)
        WriteToFile("             MkDir(AppfilePath & " & Chr(34) & " \ " & Chr(34) & " & .SoftwareName & .SoftwareVersion)" & vbCrLf)
        WriteToFile("             End If" & vbCrLf)
        WriteToFile("             strAutoRegisterKeyPath = AppfilePath & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion & " & Chr(34) & "\" & Chr(34) & " & .SoftwareName & .SoftwareVersion & " & Chr(34) & ".all" & Chr(34) & vbCrLf)
        ...
        WriteToFile("             ActivelockValues.Checksum = VerifyActiveLockNETdll()" & vbCrLf)
        ...
        WriteToFile("             .Acquire(strMsg, strRemainingTrialDays, strRemainingTrialRuns, strTrialLength, strUsedDays, strExpirationDate, strRegisteredUser, strRegisteredLevel, strLicenseClass, strMaxCount, strLicenseFileType, strLicenseType)" & vbCrLf)
