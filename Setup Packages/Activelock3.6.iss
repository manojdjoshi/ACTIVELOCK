[Setup]
AppName=Activelock VB6 3.6.0.3
AppVersion=3.6.0.3
AppVerName=Activelock VB6 3.6.0.3
...
OutputBaseFilename=Activelock_VB6_Setup_3.6.0.3_July_30_2009
OutputDir=.
...
Source: C:\ActiveLockCommunity\Activelock3.6 for VB6\Activelock3.6.dll; DestDir: "{sys}"; Flags: restartreplace sharedfile regserver; Components: bin sourcecode
