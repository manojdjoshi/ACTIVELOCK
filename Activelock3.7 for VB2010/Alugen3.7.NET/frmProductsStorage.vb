...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProductsStorage))
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(544, 134)
        ...
        '
        Me.cmdBrowseForStorageFile.Location = New System.Drawing.Point(515, 32)
        ...
        Me.txtStorageFile.Size = New System.Drawing.Size(381, 20)
        ...
        'cmdOK
        '
        Me.cmdOK.Location = New System.Drawing.Point(350, 148)
        Me.cmdOK.Name = "cmdOK"
        ...
        'cmdCancel
        '
        Me.cmdCancel.Location = New System.Drawing.Point(442, 148)
        ...
        Me.ClientSize = New System.Drawing.Size(560, 177)
...
SaveSettings_Error:
  ...
  End Sub
    ...
    Private Sub optStorageIniFile_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optStorageIniFile.CheckedChanged
        If txtStorageFile.Text = "" Then Exit Sub
        mainForm.mProductsStoreType = IActiveLock.ProductsStoreType.alsINIFile
        txtStorageFile.Text = txtStorageFile.Text.Remove(txtStorageFile.Text.Length - 3, 3) & "ini"
    End Sub

    Private Sub optStorageXmlFile_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optStorageXmlFile.CheckedChanged
        If txtStorageFile.Text = "" Then Exit Sub
        mainForm.mProductsStoreType = IActiveLock.ProductsStoreType.alsXMLFile
        txtStorageFile.Text = txtStorageFile.Text.Remove(txtStorageFile.Text.Length - 3, 3) & "xml"
    End Sub

    Private Sub optStorageMDBFile_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optStorageMDBFile.CheckedChanged
        If txtStorageFile.Text = "" Then Exit Sub
        mainForm.mProductsStoreType = IActiveLock.ProductsStoreType.alsMDBFile
        txtStorageFile.Text = txtStorageFile.Text.Remove(txtStorageFile.Text.Length - 3, 3) & "mdb"
    End Sub
End Class
