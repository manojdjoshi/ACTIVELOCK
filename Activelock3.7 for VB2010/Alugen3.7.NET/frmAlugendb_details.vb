...
#End Region
  ...
  Private Sub LoadImages()
    'load buttons images
        picALBanner.Image = CType(frmMain.resxList("I_Trust_AL_small"), Image)
        cmdCopy.Image = CType(frmMain.resxList("copy"), Image)
        cmdEmailLicenseKey.Image = CType(frmMain.resxList("email"), Image)
        cmdPrintLicenseKey.Image = CType(frmMain.resxList("print"), Image)
  End Sub
End Class
